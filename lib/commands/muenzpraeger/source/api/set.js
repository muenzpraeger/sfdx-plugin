...
const messages = command_1.core.Messages.loadMessages('@mzpr/sfdx-plugin', 'sourceApiSet');
...
SourceApiSet.description = '[DEPRECATED, use mzpr instead of muenzpraeger] ' + messages.getMessage('commandDescription');
