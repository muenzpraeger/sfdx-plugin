...
const messages = command_1.core.Messages.loadMessages('@mzpr/sfdx-plugin', 'sourceCleanupAura');
...
SourceCleanupAura.description = messages.getMessage('commandDescription');
